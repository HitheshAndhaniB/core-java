class MatchboxStarter{
	...
	public static void main(String[] matchboxes){
		...
		System.out.println("Starting main to MatchBoxStarter");
		
		Matchbox0 matchbox=new Matchbox0("king");
		...
		Matchbox0 matchbox1=new Matchbox0("king",40);
		...
		Matchbox0 matchbox2=new Matchbox0("king",40,5);
		...
		Matchbox0 matchbox3=new Matchbox0("king",40,5,2);
		...
		System.out.println("MatchBox3 pice is :"+matchbox3.price);
		...
		Matchbox0 matchbox4=new Matchbox0("king",40,5,2,"small");
		...
		System.out.println("MatchBox4 pice is :"+matchbox4.price);
		...
		Matchbox0 matchbox5=new Matchbox0("king",40,5,2,"small",6);
		...
		System.out.println("MatchBox5 pice is :"+matchbox5.price);
		...
		Matchbox0 matchbox6=new Matchbox0("king",50,4,5,"small",10,"Wood");
		...
		System.out.println("MatchBox6 pice is :"+matchbox6.price);
